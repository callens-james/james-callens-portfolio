...
#CHANGING PARAMETERS ----
wd = "C:/Users/PC/Desktop/R_script_folder_setup/rawdata/" #RAW FILE FOLDER. MUST ONLY CONTAIN YOUR RAW FILES. NEED "/" AT LOCATION END.
funcpath ="C:/Users/PC/Desktop/R_script_folder_setup/" #"app.R" FOLDER. NEED "/" AT LOCATION END.
deploy ="C:/Users/PC/Desktop/R_script_folder_setup" #"app.R" FOLDER. FOR SHINY DEPLOYMENT. NO "/" AT LOCATION END.
...
library(rsconnect)
rsconnect::deployApp(appDir = deploy, account = 'hurd-laboratory', appTitle = "heroinfr5singlecell") # deploy the shiny app
y 